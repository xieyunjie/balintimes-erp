...
(function(angular) {
	...
	angular.module('inform-com.balintimes.erp.center.exception', [ 'inform' ]).config([ "$provide", function($provide) {
	...
	angular.module('inform-http-com.balintimes.erp.center.exception', [ 'inform' ])
