    ...
    if (blockUIConfig.blockBrowserNavigation) {
      ...
      function hook(f) {
        ...
        $delegate[f] = function () {
          ...
          // The call was a setter if the $location com.balintimes.erp.center.service is returned.
...
blkUI.directive('blockUiContainer', ["blockUIConfig", "blockUiContainerLinkFn", function (blockUIConfig, blockUiContainerLinkFn) {
  ...
  return function ($scope, $element, $attrs) {
    ...
    if (!srvInstance) {
      throw new Error('No parent block-ui com.balintimes.erp.center.service instance located.');
    }
...
blkUI.directive('blockUi', ["blockUiCompileFn", function (blockUiCompileFn) {
  ...
  return function ($scope, $element, $attrs) {
    ...
    // Store a reference to the com.balintimes.erp.center.service instance on the element
